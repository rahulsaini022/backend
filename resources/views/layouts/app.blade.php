                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            @else 
                            <li><a class="nav-link" href="{{ url('/home')}}"><i
                            ...
                            <ul class="nav flex-column" id="nav_accordion">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" data-bs-target="#menu_item1"
                                        href="#"><i
                                        class="fa fa-cogs"></i>  Manage <i class="bi small bi-caret-down-fill"></i> </a>
                                    <ul id="menu_item1" class="submenu collapse" data-bs-parent="#nav_accordion">
                                        ...
                                        @hasanyrole('Admin')
                                            ...
                                            <li><a class="nav-link" href="{{ route('roles.index') }}"><i
                                                        class="fa fa-universal-access"> </i> Manage Role</a></li>
                                        @endhasrole
                                        @hasanyrole('test')
                                            <li><a class="nav-link" href="{{ route('users.index') }}"><i
                                                        class="fa fa-users"></i> Users</a></li>
                                        ...
                                        @hasanyrole('Admin|user')
                                            <li><a class="nav-link" href="{{ route('products.index') }}"><i
                                                        class="fa-brands fa-product-hunt"></i> Manage Product</a></li>
                                        @endhasrole
                                    </ul>
